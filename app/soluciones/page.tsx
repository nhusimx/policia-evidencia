        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12 border border-husi-light/20">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              <div key={idx} className={`${pilar.color} rounded-lg p-6 border-2 ${pilar.borderColor}`}>
                <div className="text-4xl mb-3">{pilar.icono}</div>
                <h3 className="text-xl font-bold mb-2 text-husi-dark">{pilar.titulo}</h3>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-husi-dark to-husi-medium rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            <Link href="#evaluador" className="bg-white text-husi-dark p-6 rounded-lg hover:shadow-xl transition">
              <div className="text-3xl mb-2">📊</div>
              <h3 className="font-bold mb-2">Evaluar Institución</h3>
              <p className="text-sm text-neutral-gray">Ideal si estás explorando opciones</p>
            </Link>
            <Link href="#simulador" className="bg-white text-husi-dark p-6 rounded-lg hover:shadow-xl transition">
              <div className="text-3xl mb-2">🎯</div>
              <h3 className="font-bold mb-2">Simular Intervención</h3>
              <p className="text-sm text-neutral-gray">Ve cómo funciona el modelo</p>
            </Link>
          </div>
        </div>
      </section>
